...
> **Note:**
> - Current live version is v0.9.1

> **Quick Links:**
> - [API documentation](https://rawgit.com/appson/identity-public/master/v0.9.1/APISpecification/content/index.htm)
> - [Web SDK](https://github.com/appson/identity-public/tree/master/v0.9.1/WebSDK)
...
You can use **AppsOn Identity** by directly calling API methods refer to the [documentation](https://rawgit.com/appson/identity-public/master/v0.9.1/APISpecification/content/index.htm) for more info.
