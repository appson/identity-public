...
> - [Web SDK](https://github.com/appson/identity-public/tree/master/v0.6.2/WebSDK)
...
You can use **AppsOn Identity** by directly calling API methods refer to the [documentation](https://rawgit.com/appson/identity-public/master/v0.6.2/APISpecification/content/index.htm) for more info.
